...
<div>
  <div class="hello">
    ...
    <div>
        <p>We are the tiny aliens in Men in Black who run around inside the heads of human robots. The Waldgrave aims to create spaces where you can comfortably and safely exit your robot for a bit with your alien friends. Current projects and goals of the Waldgrave include <router-link to="/teganandsara"> a music blog</router-link>, <router-link to="/readtogether">a bookclub app</router-link>, <router-link to="/brainstree"> a notes app</router-link>, <router-link to="/openchicago"> Open Chicago</router-link>, <router-link to="/fixingsocialsecurity">fixing social security</router-link>, reducing income equality, <router-link to="/climatechangestrats">combatting climate change</router-link> and <router-link to="/endoftheuniverse">how to (get to and) survive the heat death of the universe</router-link>
        </p>
    </div>
    <div>
